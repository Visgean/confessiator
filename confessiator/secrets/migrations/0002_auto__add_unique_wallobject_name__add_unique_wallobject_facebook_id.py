...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WallObject', fields ['name']
        db.create_unique('secrets_wallobject', ['name'])

        # Adding unique constraint on 'WallObject', fields ['facebook_id']
        db.create_unique('secrets_wallobject', ['facebook_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WallObject', fields ['facebook_id']
        db.delete_unique('secrets_wallobject', ['facebook_id'])

        # Removing unique constraint on 'WallObject', fields ['name']
        db.delete_unique('secrets_wallobject', ['name'])
    ...
    models = {
        ...
        'secrets.wallobject': {
            ...
            'facebook_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
